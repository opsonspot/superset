...
`;function y({addDangerToast:e,addSuccessToast:t,children:a,...n}){return(0,m.tZ)(g,null,(0,m.tZ)(p.Z.Copy,{tabIndex:0,role:"button",onClick:s=>{var n;s.preventDefault(),s.currentTarget.blur(),n=a,(0,h.Z)((()=>Promise.resolve(n))).then((()=>{t&&t((0,l.t)("SQL Copied!"))})).catch((()=>{e&&e((0,l.t)("Sorry, your browser does not support copying."))}))}}),(0,m.tZ)(c.Z,(0,s.Z)({style:u.Z},n),a))}},286185:(e,t,a)=>{a.d(t,{Z:()=>n});var s=a(667294);function n({queries:e,fetchData:t,currentQueryId:a}){const n=e.findIndex((e=>e.id===a)),[l,r]=(0,s.useState)(n),[o,i]=(0,s.useState)(!1),[d,u]=(0,s.useState)(!1);function c(){i(0===l),u(l===e.length-1)}function p(a){const s=l+(a?-1:1);s>=0&&s<e.length&&(t(e[s].id),r(s),c())}return(0,s.useEffect)((()=>{c()})),{handleKeyPress:function(t){l>=0&&l<e.length&&("ArrowDown"===t.key||"k"===t.key?(t.preventDefault(),p(!1)):"ArrowUp"!==t.key&&"j"!==t.key||(t.preventDefault(),p(!0)))},handleDataChange:p,disablePrevious:o,disableNext:d}}},7742:(e,t,a)=>{a.r(t),a.d(t,{default:()=>j});var s=a(61988),n=a(751995),l=a(431069),r=a(593185),o=a(667294),i=a(616550),d=a(473727),u=a(115926),c=a.n(u),p=a(440768),h=a(828216),m=a(799299),g=a(414114),y=a(34858),b=a(419259),v=a(232228),Z=a(586074),f=a(593139),w=a(838703),S=a(217198),x=a(129848),k=a(583556),T=a(358593),_=a(933726),$=a(400012),q=a(710222),C=a(727989),P=a(554070),N=a(860718),D=a(313322),F=a(774069),H=a(835932),K=a(106189),E=a(286185),I=a(211965);const L=n.iK.div`
...
//# sourceMappingURL=1311280a2f715134beae.chunk.js.map