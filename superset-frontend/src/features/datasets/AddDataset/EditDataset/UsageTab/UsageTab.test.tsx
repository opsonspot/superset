...
test('show chart dashboards', async () => {
  ...
  expect(chartDashboards[0]).toHaveAttribute('href', '/woodfrog/dashboard/1');
  expect(chartDashboards[1]).toHaveTextContent('Sample dashboard B');
  expect(chartDashboards[1]).toHaveAttribute('href', '/woodfrog/dashboard/2');
  ...
  expect(chartDashboards[2]).toHaveAttribute('href', '/woodfrog/dashboard/3');
