...
export const WORLD_HEALTH_DASHBOARD = '/woodfrog/dashboard/world_health/';
export const SAMPLE_DASHBOARD_1 = '/woodfrog/dashboard/1-sample-dashboard/';
export const SUPPORTED_CHARTS_DASHBOARD =
  '/woodfrog/dashboard/supported_charts_dash/';
export const TABBED_DASHBOARD = '/woodfrog/dashboard/tabbed_dash/';
